...
```
app/agents/ingest.py       — Gemini 1.5 Flash, photo/text → IdentifiedItem[]
app/agents/analyst.py      — Emissions Engine → ActivityRecord (no LLM)
app/agents/coach.py        — Gemini 1.5 Pro, weekly batch → CoachNudge
app/agents/forecast.py     — Emissions Engine → ForecastScenario (no LLM)
app/agents/conversation.py — Gemini 1.5 Flash, SSE streaming → grounded Q&A
